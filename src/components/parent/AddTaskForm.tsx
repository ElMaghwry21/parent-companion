          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="flex items-center justify-between p-4 glass-premium rounded-2xl border border-white/5 hover:bg-white/10 transition-colors">
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${isRoutine ? 'bg-secondary/20 text-secondary shadow-[0_0_15px_rgba(236,72,153,0.3)]' : 'bg-muted text-muted-foreground'}`}>
                  {isRoutine ? '🔁' : '🎯'}
                </div>
                <div className="space-y-0.5 text-left">
                  <Label className="font-black text-xs uppercase tracking-widest cursor-pointer">Daily Routine</Label>
                  <p className="text-[9px] text-muted-foreground uppercase font-black tracking-tighter italic">Resets every midnight</p>
                </div>
              </div>
